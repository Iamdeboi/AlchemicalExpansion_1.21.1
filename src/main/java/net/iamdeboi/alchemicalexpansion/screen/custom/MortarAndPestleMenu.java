...
public class MortarAndPestleMenu extends AbstractContainerMenu {
    ...
    public MortarAndPestleMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MORTAR_AND_PESTLE_MENU.get(), pContainerId);
        this.blockEntity = ((MortarAndPestleBlockEntity) entity);
        ...
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 0, 26, 35));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 1, 134, 35));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.MORTAR_AND_PESTLE_BLOCK.get());
    }
